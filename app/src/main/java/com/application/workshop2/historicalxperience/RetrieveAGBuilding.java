...
public class RetrieveAGBuilding extends AppCompatActivity implements ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrieve_agbuilding);
    ...
    public void onClick(View view, int position) {
        Intent intentDetail = new Intent(RetrieveAGBuilding.this, MTDetail.class);
